...
from customer_group.graphql import types
from customer_group.graphql.errors import CustomerGroupError

from saleor.graphql.core.mutations import ModelDeleteMutation, ModelMutation
from customer_group import models
from customer_group.graphql.custom_permissions import CustomerGroupPermissions
...
class CustomerGroupCreate(ModelMutation):
    ...
    class Meta:
        ...
        object_type = types.CustomerGroup
